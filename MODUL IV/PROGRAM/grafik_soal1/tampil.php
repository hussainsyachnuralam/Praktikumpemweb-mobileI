...
<html>
<head>
	<title>GRAFIK SURVEI PENGUNJUNG PERPUSTAKAAN UNIVERSITAS</title>
...
<body>
	...
	<center>
		<h2>GRAFIK SURVEI PENGUNJUNG PERPUSTAKAAN UNIVERSITAS</h2>
	</center>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			type: 'bar',
			data: {
				labels: ["Teknik", "Ekonomi", "Fisip", "Pertanian", "Keguruan"],
				datasets: [{
					label: '',
					data: [
					<?php 
					...
					?>,
					<?php 
					$jumlah_keguruan = mysqli_query($koneksi,"select * from mahasiswa where fakultas='keguruan'");
					echo mysqli_num_rows($jumlah_keguruan);
					?>
					],
					backgroundColor: [
					'rgba(255, 99, 132, 0.2)',
